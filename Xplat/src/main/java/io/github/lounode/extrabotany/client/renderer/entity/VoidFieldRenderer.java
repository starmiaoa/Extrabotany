...
public class VoidFieldRenderer extends EntityRenderer<HerrscherVoidFieldEntity> {
	...
	private static void quad(Matrix4f matrix, VertexConsumer vertex, int color) {
		vertex.addVertex(matrix, -1.5F, -1.5F, 0.0F).setColor(color).setUv(0.0F, 1.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(0xF000F0).setNormal(0.0F, 0.0F, 1.0F);
		vertex.addVertex(matrix, 1.5F, -1.5F, 0.0F).setColor(color).setUv(1.0F, 1.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(0xF000F0).setNormal(0.0F, 0.0F, 1.0F);
		vertex.addVertex(matrix, 1.5F, 1.5F, 0.0F).setColor(color).setUv(1.0F, 0.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(0xF000F0).setNormal(0.0F, 0.0F, 1.0F);
		vertex.addVertex(matrix, -1.5F, 1.5F, 0.0F).setColor(color).setUv(0.0F, 0.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(0xF000F0).setNormal(0.0F, 0.0F, 1.0F);
	}
