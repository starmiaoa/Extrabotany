...
public class ModelVoidHerrscher extends HumanoidModel<VoidHerrscher> {
	...
	public void renderBody(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
		...
		bodyWear.render(poseStack, buffer, packedLight, packedOverlay, color);
		leftArmWear.render(poseStack, buffer, packedLight, packedOverlay, color);
		rightArmWear.render(poseStack, buffer, packedLight, packedOverlay, color);
		leftLegWear.render(poseStack, buffer, packedLight, packedOverlay, color);
		rightLegWear.render(poseStack, buffer, packedLight, packedOverlay, color);
	}

	@Override
	public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
		renderBody(poseStack, buffer, packedLight, packedOverlay, color);
	}

	public void renderWings(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
	...
	public void renderShields(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
		shield1.render(poseStack, buffer, packedLight, packedOverlay, color);
		shield2.render(poseStack, buffer, packedLight, packedOverlay, color);
		shield3.render(poseStack, buffer, packedLight, packedOverlay, color);
	}
