...
public class EmiExtrabotanyPlugin implements EmiPlugin {
	...
	public void register(EmiRegistry registry) {
		...
		registry.setDefaultComparison(ExtraBotanyItems.coreOfTheVoid, Comparison.compareNbt());
		...
		for (StonesiaRecipe recipe : registry.getRecipeManager().getAllRecipesFor(ExtraBotanyRecipeTypes.STONESIA_RECIPE_TYPE)) {
			if (!recipe.getInput().getDisplayed().isEmpty()) {
