...
/**
 * 本我武器发射逻辑(忠实移植老 EGO 的 5 把 relic),从任意 {@link LivingEntity} 发射者朝目标发射。
 * Boss 二阶段({@link GaiaEgoSwordAttack})与本我仆从({@code EgoMinionEntity})共用,
 * 弹体自带"非玩家所有者=真伤"分支,无需额外伤害处理。
 *
 * <p>weapon: 0=真影刃(3 连散射) 1=真泰拉之刃(单发) 2=波涌之刃(连锁) 3=狂星之怒(5 陨星) 4=最初分型(幻影剑)。
 */
public final class EgoWeaponFire {
	...
	// 镜像 TrueShadowKatanaItem#useSword 的 3 连散射,但从发射者朝目标发射。
	...
	// 镜像 StarWrathItem#useSword:目标点上方落 5 颗陨星。
	...
	// 镜像 FirstFractalItem#useSword:3 把延迟幻影剑 + 1 把特殊幻影剑。
