...
public class MotorEntity extends Entity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TECTONIC_ENERGY, 0);
		builder.define(CYCLONE_TICKS, 0);
		builder.define(LEAN, 0F);
	...
	private ItemStack getItemStack() {
		...
		getOwner().ifPresent(owner -> ItemStackDataHelper.setString(stack, "soulbindUUID", owner.toString()));
		return stack;
	}
