...
public class MotorModel extends EntityModel<MotorEntity> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay,
		...
		frontWheel.render(poseStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
		backWheel.render(poseStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}
